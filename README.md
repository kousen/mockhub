...
- **MCP server** — 25 tools for AI agent integration (events, cart, orders, pricing, mandates) with OAuth 2.1 authentication and Dynamic Client Registration (DCR) — works natively with Claude (desktop, web, mobile), Cursor, and any MCP-compatible client
